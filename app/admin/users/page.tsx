...
export default function AdminUsersPage() {
  const users = [
    { id: "1", name: "John Doe", email: "john.doe@petrosphere.com", role: "user", courses: 5, status: "active" },
    { id: "2", name: "Sarah Johnson", email: "sarah.j@petrosphere.com", role: "user", courses: 8, status: "active" },
    { id: "3", name: "Michael Chen", email: "m.chen@petrosphere.com", role: "admin", courses: 12, status: "active" },
    { id: "4", name: "Emily Davis", email: "emily.d@petrosphere.com", role: "user", courses: 3, status: "inactive" },
  ]
              ...
              <tbody>
                {users.map((user) => (
                  ...
                  >
                    ...
                    <td className="p-4">
                      <span className="text-sm text-foreground">{user.courses} enrolled</span>
                    </td>
                    <td className="p-4">
